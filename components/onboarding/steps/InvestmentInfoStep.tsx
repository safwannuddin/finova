...
export default function InvestmentInfoStep({ onSubmit, onBack }: InvestmentInfoStepProps) {
  ...
  const handleSubmit = async (data: FormData) => {
    ...
    try {
      // Log submission
      console.log("Investment info submitted:", data);
      
      // Call onSubmit to update the user data in context
      onSubmit(data);
      
      console.log("Onboarding should now be complete");
      
      // Force a hard navigation to dashboard - this is the most reliable method
    ...
    // Note: We don't set isSubmitting to false since we're navigating away
  };
